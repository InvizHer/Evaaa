class script(object):
    START_TXT = """<b>ʜᴇʏ ᴛʜᴇʀᴇ {} 🙋🏻</b>
    
ɪ'ᴍ ᴇᴍɪxɪɴᴀ, ᴀɴ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ꜰᴏʀ ʜᴇʟᴘɪɴɢ ᴛᴏ ꜱᴇᴀʀᴄʜ ɪɴᴅɪᴀɴ ʙᴏʟʟʏᴡᴏᴏᴅ, ᴛᴏʟʟʏᴡᴏᴏᴅ ᴏʀ ʜᴏʟʟʏᴡᴏᴏᴅ ᴍᴏᴠɪᴇꜱ. ɪ ᴄᴀɴ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ꜱᴇᴀʀᴄʜ ᴍᴏᴠɪᴇꜱ ᴡɪᴛʜ ɪᴍᴅʙ ꜰᴇᴀᴛᴜʀᴇ ᴀʟꜱᴏ. ᴊᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴇɴᴊᴏʏ ᴍʏ ᴘʀᴇᴍɪᴜᴍ ғᴇᴀᴛᴜʀᴇs ғʀᴇᴇ ᴏғ ᴄᴏsᴛ..

<b>ɢᴇᴛ ᴍᴏʀᴇ ɪɴꜰᴏ ᴀʙᴏᴜᴛ ᴍᴇ ʙᴇʟᴏᴡ.</b>"""
    HELP_TXT = """<b>ᴜsᴇ ғᴏʟʟᴏᴡɪɴɢ ʙᴜᴛᴛᴏɴs ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ</b>"""
