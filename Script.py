...
ɪ'ᴍ ᴇᴍɪxɪɴᴀ ʙᴏᴛ ꜰᴏʀ ʜᴇʟᴘɪɴɢ ᴛᴏ ꜱᴇᴀʀᴄʜ ɪɴᴅɪᴀɴ ʙᴏʟʟʏᴡᴏᴏᴅ, ᴛᴏʟʟʏᴡᴏᴏᴅ ᴏʀ ʜᴏʟʟʏᴡᴏᴏᴅ ᴍᴏᴠɪᴇꜱ. ɪ ᴄᴀɴ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ꜱᴇᴀʀᴄʜ ᴍᴏᴠɪᴇꜱ ᴡɪᴛʜ ɪᴍᴅʙ ꜰᴇᴀᴛᴜʀᴇ ᴀʟꜱᴏ.

<b>ᴊᴜsᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ sᴛᴀʀᴛ ᴇɴᴊᴏʏɪɴɢ ᴍᴏᴠɪᴇs ғʀᴇᴇ ᴏғ ᴄᴏsᴛ.</b>"""
    HELP_TXT = """<b>Hᴇʏ {}
